...
class ContactData extends React.Component {
    ...
    inputChangeHandler = (event, inputIdentity) => {
        console.log('the evevnt ', inputIdentity);
        ...
        const updatedFormElement = updateObject(this.state.orderForm[inputIdentity], {
            value: event.target.value,
            valid: checkValidity(event.target.value, this.state.orderForm[inputIdentity].validation),
            touched: true
        });
